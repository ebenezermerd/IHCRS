...
<!--  #HEADER ENDS HERE -->
    <div class="home-container">
        <div class="src-screen">
            <div class="sec-container">
            <div class="src-up">
                <div class="welcome-box">
                    <h1>WELCOME TO OUR WEBSITE</h1>
                    <h2>We Are Realtime Medical Service Providers With Quality Interface</h2>
                    <h2>This websiste will provide different services with security environment.</h2>
                    <p>" The face of nature will only be maintained with intensive care.</p>
            ...
            <div class="src-sectionA">
                <div class="pic-tes">
                </div>
                <div class="pic-text-room">
                  <h3>"As a medical professional with over 15 years of experience, I have had the privilege of working with numerous healthcare facilities and colleagues throughout my career. Among them, I can confidently say that my time at ABC Medical Center has been the most fulfilling and rewarding."</h3>
                </div>    
            </div>
            <div class="src-sectionB">
                <div class="sec-grid-container">
                    <div class="sec-grid templateA"></div>
                    <div class="sec-grid templateB"></div>
                    <div class="sec-grid templateC"></div>
                    <div class="sec-grid templateD"></div>
                </div>    
            </div>
            <!-- <div class="src-sectionC">
                <div class="sec-grid-containerB">
                    <div class="secB-grid BtemplateA">
                        <div class="tiny-prof profA"></div>
                    </div>
                    <div class="secB-grid BtemplateB">
                        <div class="tiny-prof profB"></div>                      
                    </div>
                    <div class="secB-grid BtemplateC">
                        <div class="tiny-prof profC"></div>                      
                    </div>
                    <div class="secB-grid BtemplateD">
                        <div class="tiny-prof profC"></div>
                    </div>
                </div>     -->
            </div>
            <div class="src-sectionD">
               <div class="srcD-cirle-kit"></div>    
                <div class="src-flex-container">
                    <div class="flex-items flextext">
                      <h1>Outlook</h1>
                      <h3>The site provides medical services such as live communication with professionals
                        , locations for halthcare centers and realtime referral service among healthcare centers.</h3>
                        <h4>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur esse expedita impedit
                           quod blanditiis, magni sapiente molestiae quos aliquid labore, voluptatem corporis amet pariatur
                            aliquam fuga ad voluptates minus aperiam!</h4>
                    </div>
                    <div class="flex-items flexpicture">
