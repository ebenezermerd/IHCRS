...
<div class="wrapper">
  <div class="Homespace">
      <button class="left-button" id="docMgmt">Manage Doctors</button>
    ...
    <div class="welcomeText">
      ...
      <!-- php session code !!!-->
   <center>  <h2 style=" color:antiquewhite"> <?php 
      session_start();
      echo $_SESSION["hname"];
      ?></h2><center>
</div>
  ...
  <script>
  var docBtn = document.getElementById("docMgmt");
  var userBtn = document.getElementById("userMgmt");

  docBtn.addEventListener("click", function() {
    window.location.href = "docManagement/main_page.php";
  });
