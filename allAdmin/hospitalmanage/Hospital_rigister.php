...
if(isset($_POST["register"])){
  ...
  if($obj->register($_POST)){
    ...
    header("location: display_hospital.php?frm='$message'");
  }else{
  ...
  <h1>Register Hospital</h1>
    <div class="Hospital-records">
      <div class="menu">
        <ul>
          <nav class="menu Hospital-management">
            ...
            <ul class="hidden">
              <li><a id = "curr" href="#">Add Hospital</a></li>
      ...
      <div class="record-form">
        ...
        <h3>Update Hospital Info</h3> <span style="color: red;">
          <?php 
         if(isset($message)){
          echo $message;
         }
        ...
        <form method="post" action="Hospital_rigister.php">
          
            <label for="Hname">Hospital Name:</label>
            <input type="text" id="Hname" required name="Hname"  />
            ...
            <input type="text" id="Apassword" required name="Apassword" />
            ...
            <input type="text" id="Hlocation" required name="Hlocation" />

            <label for="Date">Registration Date:</label>
            <input type="date" id="Date" required name="Date" />

            <label for="Num">Phone Number:</label>
            <input type="text" id="Num" required name="Num" />
