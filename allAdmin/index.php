...
<div class="wrapper">
  <div class="Homespace">
      <button class="left-button" id="infoHost">Display Information</button>
      <button class="right-button" id="hostMgmt">Manage Hospitals</button>  
    </div>
  </div>
  <script>
  var hostH = document.getElementById("hostMgmt");
  var Info = document.getElementById("infoHost");

  hostH.addEventListener("click", function() {
    window.location.href = "hospitalmanage/main_page.php";
  });

  Info.addEventListener("click", function() {
    window.location.href = "hospitalmanage/display_hospital.php";
  });
</script>
  <!--  #FOOTER  -->
