...
session_start();
 ...
 $sql="SELECT * FROM patient_referral WHERE patient_id='$id'";
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="../services/index.php" class="navbar-link title-md">Home</a>
          </li>

          <li class="navbar-item">
            <a href="../services/index.php" class="navbar-link title-md" active>Services</a>
          </li>
...
<div class="wrapper">
<div class="classList">
  <h1> Referral Available:</h1>
<form id="patient-form" class="patient-form" action="" method="POST">
      ...
      <div class="form-columns">
        <div class="form-column">
          <fieldset>
            ...
            echo'
            <legend>Referraal stu  Information</legend>
            <label for="patient-id">Patient ID:</label>
            <input type="text" value="'.$data["patient_id"].'" id="patient-id" name="patient_id"  readonly>
            <label for="full-name">Full Name:</label>
            <input type="text" value="'.$data["full_name"].'" id="full-name" name="full_name" readonly>
            <label for="surname">Surname:</label>
            <input type="text" value="'.$data["surname"].'" id="surname" name="surname" readonly>
            <label for="surgery">Surgery:</label>
            <input type="text" value="'.$data["surgery"].'"  id="surgery" name="surgery" readonly>
            <label for="phone">Phone:</label>
            <input type="text" value="'.$data["phone"].'"  id="phone" name="phone" readonly>
            <label for="mobile">Mobile:</label>
            <input value="'.$data["mobile"].'"  type="text" id="mobile" name="mobile" readonly>
          </fieldset>
        </div>
        <div class="form-column">
          <fieldset>
            ...
            <input value="'.$data["fax"].'"  type="text" id="fax" name="fax" readonly>
            <label for="email">Email:</label>
            <input type="email" value="'.$data["email"].'"  id="email" name="email" readonly>
            <label for="address-line">Address Line:</label>
            <input type="text" value="'.$data["address"].'"  id="address-line" name="address_line" readonly>
            <label for="postcode">Postcode:</label>
            <input type="text" id="postcode" value="'.$data["post_code"].'"  name="post_code">
            <label for="transport-requirement">Transport Requirement:</label>
            <select id="transport-requirement" value="'.$data["transport"].'"  name="transport_requirement" readonly>
              <option value="yes">Yes</option>
              <option value="no">No</option>
            </select>
           <label for="referralTo">Referral To:</label>
            <input type="text" id="referral" value="'.$data["referral_to"].'" name="referral" readonly>           
          </fieldset>';} ?>
        </div>
      </div>
    </form>
