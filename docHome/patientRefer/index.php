...
<!--  #HEADER ENDS HERE -->
    ...
    <div class="classContainer">
          <div class="referral_container">
            <h1 class="page-name">Referral Patient</h1>

            <div class="referralSearchContainer">
              <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
              <input type="text" class="referralSearchInput" name="patient_id" placeholder="   Search...">
              <button type="submit" class="referralSearchButton">Search</button></form>
            </div>
            ...
            <table class="patient-table">
              ...
              <tbody>
              <?php include 'php/conn_data.php'; ?>
              </tbody>
            </table>

          <table class="approved-patients-table">
              <thead>
                <tr>
                  <th>Patient Name</th>
                  <th>Patient ID</th>
              ...
              <tbody>
              <?php
                  include 'php/approved_fetch.php';
                  $approvedFetcher = new approvedFetch();
                  $patients = $approvedFetcher->getPatients();
    ...
    <?php require 'php/fetchPatient.php' ?>
            <!-- Form section -->
        <form class="patient-form" action="php/patient_referral.php" method="POST">
          <div class="form-columns">
            <div class="form-column">
              <fieldset>
                <legend>Patient Information</legend>
                <label for="patient-id">Patient ID:</label>
                <input type="text" id="patient-id" name="patient_id" value="<?php echo isset($patientData['patient_id']) ? $patientData['patient_id'] : ''; ?>" readonly>
                <label for="full-name">Full Name:</label>
                <input type="text" id="full-name" name="full_name" value="<?php echo isset($patientData['full_name']) ? $patientData['full_name'] : ''; ?>">
                <label for="surname">Surname:</label>
                <input type="text" id="surname" name="surname">
                <label for="surgery">Surgery:</label>
                <input type="text" id="surgery" name="surgery">
                <label for="phone">Phone:</label>
                <input type="text" id="phone" name="phone" value="<?php echo isset($patientData['phone']) ? $patientData['phone'] : ''; ?>">
            ...
            <div class="form-column">
              <fieldset>
                ...
                <input type="email" id="email" name="email" value="<?php echo isset($patientData['email']) ? $patientData['email'] : ''; ?>">
                <label for="address-line">Address Line :</label>
                <input type="text" id="address-line" name="address" value="<?php echo isset($patientData['location']) ? $patientData['location'] : ''; ?>">
                <label for="postcode">Postcode:</label>
                <input type="text" id="postcode" name="post_code">
                <label for="transport-requirement">Transport Requirement:</label>
                <select id="transport-requirement" name="transport_requirement">
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </select>
                <label for="referral-to">Referral To:</label>
                <select id="referral-to" name="referral_to">
                 <?php 
                 ...
                 if($result->num_rows > 0){
                  while($data=$result->fetch_assoc()){
                    echo '<option value="'.$data["hname"].'">'.$data["hname"].'</option>';
                  }
                 }
