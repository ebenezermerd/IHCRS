...
if (isset($_POST['patient_register'])) {
    ...
    if ($x) {
		...
		window.onload = function() {
			...
			newWindow.location.href = 'card.php?email=<?php echo  $email?>&password=<?php echo  $pass?>&name=<?php echo  $name?>&id=<?php echo  $pass?>&name=<?php echo  $p_id?>'; 
			window.location.href = '../patient_rigister.php';
